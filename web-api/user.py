...
def createUserProfile(UsersDB):
    stmt = ''' INSERT INTO Profiles(PUSER_ID,FIRST_NAME,LAST_NAME,COUNTRY,ZIPCODE,CITY,STREET,STATE) VALUES (:PUSER_ID,:FIRST_NAME,:LAST_NAME,:COUNTRY,:ZIPCODE,:CITY,:STREET,:STATE) '''
